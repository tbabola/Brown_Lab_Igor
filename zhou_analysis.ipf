...
macro setup()
	...
	duplicate /o adc0_avg_0 spike_1
	duplicate /o adc0_avg_0 spike_2
	duplicate /o adc0_avg_0 spike_3
	
	duplicate /o adc0_avg_0 response_1to0
	duplicate /o adc0_avg_0 response_2to0
	duplicate /o adc0_avg_0 response_3to0
	
	duplicate /o adc0_avg_0 response_0to1
	duplicate /o adc0_avg_0 response_2to1
	duplicate /o adc0_avg_0 response_3to1

	duplicate /o adc0_avg_0 response_0to2
	duplicate /o adc0_avg_0 response_1to2
	duplicate /o adc0_avg_0 response_3to2
	
	duplicate /o adc0_avg_0 response_0to3
	duplicate /o adc0_avg_0 response_1to3
	duplicate /o adc0_avg_0 response_2to3
end macro
...
macro copy_spike_0()
	...
	duplicate /o adc3_avg_0 response_3to0
end macro
...
macro copy_spike_1()
	...
	duplicate /o adc3_avg_0 response_3to1
end macro 
...
macro copy_spike_2()
	...
	duplicate /o adc3_avg_0 response_3to2
end macro

macro copy_spike_3()
	duplicate /o adc3_avg_0 spike_3
	duplicate /o adc0_avg_0 response_0to3
	duplicate /o adc1_avg_0 response_1to3
	duplicate /o adc2_avg_0 response_2to3
end macro




Window zhou_start() : Graph
	...
	ModifyGraph rgb(response_3to0)=(0,0,0),rgb(spike_1)=(32768,54528,65280),rgb(response_2to1)=(0,65280,0)
	ModifyGraph rgb(response_3to1)=(0,0,0),rgb(spike_2)=(0,65280,0),rgb(response_0to2)=(65280,0,0)
	ModifyGraph rgb(response_1to2)=(32768,54528,65280),rgb(response_3to2)=(0,0,0),rgb(spike_3)=(0,0,0)
	...
	ModifyGraph axisEnab(ax_spike_0)={0.8,1}
	ModifyGraph axisEnab(bot_ax_spike_0)={0.01,0.24}
	ModifyGraph axisEnab(ax_res_1to0)={0.51,0.74}
	ModifyGraph axisEnab(ax_res_2to0)={0.26,0.49}
	ModifyGraph axisEnab(ax_res_3to0)={0.01,0.24}
	ModifyGraph axisEnab(ax_spike_1)={0.8,1}
	ModifyGraph axisEnab(bot_ax_spike_1)={0.26,0.49}
	ModifyGraph axisEnab(ax_res_0to1)={0.51,0.74}
	ModifyGraph axisEnab(ax_res_2to1)={0.26,0.49}
	ModifyGraph axisEnab(ax_res_3to1)={0.01,0.24}
	ModifyGraph axisEnab(ax_spike_2)={0.8,1}
	ModifyGraph axisEnab(bot_ax_spike_2)={0.51,0.74}
	ModifyGraph axisEnab(ax_res_0to2)={0.51,0.74}
	ModifyGraph axisEnab(ax_res_1to2)={0.26,0.49}
	ModifyGraph axisEnab(ax_res_3to2)={0.01,0.24}
...
Window Layout_zhou() : Layout
	PauseUpdate; Silent 1		// building window...
	Layout/C=1/W=(425.25,172.25,926.25,604.25) zhou_start(105.75,171.75,537.75,603.75)/O=1/F=0/T
	TextBox/C/N=text0/A=LB/X=81.67/Y=90.02 "CELL NAMES\rDATE\rDate of analysis\rComments"
EndMacro
